        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
          <thead>
            <tr style={{ background: 'var(--navy-50)', borderBottom: '1px solid var(--line)' }}>
              {['Name', 'Contact', 'Property Interest', 'Source', 'Status', 'Notified', 'Time', ''].map(h => (
          ...
          <tbody>
            {leads.map((lead, i) => (
              <tr key={lead.id} style={{ borderBottom: i < leads.length - 1 ? '1px solid var(--line)' : 'none', transition: 'background .1s' }}
